...
test("Deve fazer o cálculo do preço de uma corrida durante o dia", function () {    
    ...
    ride.addPosition(-27.584905257808835, -48.545022195325124, new Date('2023-03-01T10:00:00'));    
    ride.addPosition(-27.496887588317275, -48.522234807851476, new Date('2023-03-01T10:00:00'));    
    expect(ride.calculate()).toBe(21);
});

test("Deve fazer o cálculo do preço de uma corrida durante a noite", function () {
    const ride = Ride.create("", new Coord(0,0), new Coord(0,0));    
    ride.addPosition(-27.584905257808835, -48.545022195325124, new Date('2023-03-01T23:00:00'));    
    ride.addPosition(-27.496887588317275, -48.522234807851476, new Date('2023-03-01T23:00:00'));    
    expect(ride.calculate()).toBe(39);
});

test("Deve fazer o cálculo do preço de uma corrida no domingo de dia", function () {
    const ride = Ride.create("", new Coord(0,0), new Coord(0,0));    
    ride.addPosition(-27.584905257808835, -48.545022195325124, new Date('2023-03-07T10:00:00'));    
...
test("Deve fazer o cálculo do preço de uma corrida no domingo de noite", function () {
    const ride = Ride.create("", new Coord(0,0), new Coord(0,0));    
    ride.addPosition(-27.584905257808835, -48.545022195325124, new Date('2023-03-07T23:00:00'));    
...
test("Deve fazer o cálculo do preço de uma corrida durante o dia com preço mínimo", function () {    
    const ride = Ride.create("", new Coord(0,0), new Coord(0,0));
    ride.addPosition(-27.584905257808835, -48.545022195325124, new Date('2023-03-07T10:00:00'));    
    ride.addPosition(-27.579020277800876, -48.50838017206791, new Date('2021-03-07T10:00:00'));
...
// test("Não pode aceitar uma corrida se ela não tiver sido solicitada", function () {    
//     const ride = Ride.create("", new Coord(0,0), new Coord(0,0));
//     expect(() => ride.accept(ride.driverId, new Date("2021-03-01T10:40:00"))).toThrow("Ride was not requested yet");
// });
...
test("Não pode encerrar uma corrida se ela não tiver sido iniciada", function () {    
    const ride = Ride.create("", new Coord(0,0), new Coord(0,0));
